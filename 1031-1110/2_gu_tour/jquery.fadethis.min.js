...
!(function (a, b, c) {
  ...
  (a.expr[':'].hasClassStartingWith = function (a, b, c) {
    ...
    (g.prototype = {
      globals: { pluginName: 'fadeThis', bufferTime: 300 },
      defaults: {
        baseName: 'slide-',
        speed: 500,
        easing: 'swing',
      ...
      addElements: function (d, e) {
        ...
        return (
          g.is(":hasClassStartingWith('" + i + "')")
            ? h._addElement(g, e)
            : g.find(":hasClassStartingWith('" + i + "')").each(function () {
      ...
      _addElement: function (b, c) {
        var d = b.data('plugin-options'),
          ...
          g = { element: b, options: f, invp: !1 };
        return e.push(g), this._prepareElement(g), b;
      },
      _prepareElement: function (a) {
        var b = { opacity: 0, visibility: 'visible', position: 'relative' },
          c = null;
        ...
        a.each(e, function (a, d) {
          c._isVisible(d)
            ? d.invp ||
              ((d.invp = !0),
              c._triggerFading(d),
              d.options.scrolledIn && d.options.scrolledIn.call(d.element, b),
              d.element.trigger('fadethisscrolledin', b))
            : d.invp &&
              ((d.invp = !1),
              d.options.reverse && c._triggerFading(d, !1),
              d.options.scrolledOut && d.options.scrolledOut.call(d.element, b),
              d.element.trigger('fadethisscrolledout', b));
        });
      },
      ...
      _triggerFading: function (a, b) {
        ...
        (c[e] = 0),
          ...
          b
            ? a.element.stop(!0).animate(c, a.options.speed, a.options.easing)
            : a.element.stop(!0).animate(d, a.options.speed, a.options.easing);
      },
    }),
    (g.defaults = g.prototype.defaults),
    (g.globals = g.prototype.globals),
    (b.Plugin = new g()),
    (a.fn[g.globals.pluginName] = function (c) {
      return (
        this.each(function () {
          a.data(b, 'plugin_' + g.globals.pluginName)
            ? a.data(this, 'plugin_' + g.globals.pluginName) ||
              a.data(
                this,
                'plugin_' + g.globals.pluginName,
                b.Plugin.addElements(this, c),
              )
            : (a.data(b, 'plugin_' + g.globals.pluginName, 'set'),
              a.data(
                this,
                'plugin_' + g.globals.pluginName,
                b.Plugin.init(this, c),
              ));
        }),
        this
      );
